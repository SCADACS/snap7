...
namespace Snap7
{
    ...
    public class S7Client
    {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Cli_PlcGetStatus(IntPtr Client, ref Int32 Status);
        public int PlcGetStatus(ref Int32 Status)
        {
            return Cli_PlcGetStatus(Client, ref Status);
        }
    ...
    public class S7Server
    {
        ...
        [DllImport(S7Consts.Snap7LibName)]
        protected static extern int Srv_RegisterArea(IntPtr Server, Int32 AreaCode, Int32 Index, ref byte[] pUsrData, Int32 Size);
        public int RegisterArea(Int32 AreaCode, Int32 Index, ref byte[] pUsrData, Int32 Size)
        {
            return Srv_RegisterArea(Server, AreaCode, Index, ref pUsrData, Size);
        }
